...
class SettingsService {
  ...
  // 同期取得用ゲッター
  static bool get isBgmEnabledSync => prefs.getBool(_bgmEnabledKey) ?? true;
  static bool get isSeEnabledSync => prefs.getBool(_seEnabledKey) ?? true;
  static bool get isHighlightEnabledSync => prefs.getBool(_highlightEnabledKey) ?? true;
  static bool get isVibrationEnabledSync => prefs.getBool(_vibrationEnabledKey) ?? true;
  static int get hintLimitSync => prefs.getInt(_hintLimitKey) ?? 3;
  static int get lifeLimitSync => prefs.getInt(_lifeLimitKey) ?? 5;
  static bool get isUnlockAllSync => prefs.getBool(_unlockAllKey) ?? false;
